          ...
          <div class="grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-6 xl:grid-cols-4 2xl:gap-7.5">
            ...
            <div
              ...
              <div class="flex h-11.5 w-11.5 items-center justify-center rounded-full bg-meta-2 dark:bg-meta-4">
                ...
                <svg fill="none" class="fill-primary dark:fill-white" stroke="currentColor" width="20" height="22" viewBox="0 0 20 20" stroke-width="1.5" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
            ...
            <div
              ...
              <div class="flex h-11.5 w-11.5 items-center justify-center rounded-full bg-meta-2 dark:bg-meta-4">
                ...
                <svg fill="none" stroke="currentColor" stroke-width="1.5" class="fill-primary dark:fill-white" width="22" height="22" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
            ...
            <div
              ...
              <div class="flex h-11.5 w-11.5 items-center justify-center rounded-full bg-meta-2 dark:bg-meta-4">
                ...
                <svg fill="none" stroke="currentColor" stroke-width="1.5" class="fill-primary dark:fill-white" width="22" height="18" viewBox="0 0 22 18" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
