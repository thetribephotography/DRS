        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-sm">
                    <form action="{{ route ('group.create') }}" method="POST" class="p-6">
                        @csrf
                        <div class="mb-6">
                        ...
                        <div class="mb-6">
                          ...
                          <input name="members" type="text" id="members" class="bg-gray-50 border border-gray-300 text-black-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 white:bg-gray-700" placeholder="Input Group Members" required>
                        </div>
