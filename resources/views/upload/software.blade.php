            ...
            <div class="bg-white px-4 py-5 sm:p-6">
              <div class="grid grid-cols-6 gap-6">
                <div class="col-span-6 sm:col-span-4">
                    ...
                    <input type="hidden" name="type" readonly value="software" >

                  <label for="title" class="block text-sm font-medium text-gray-700">Title</label>
                  <input type="text" name="title" id="title" value="{{old('title')}}" autocomplete="given-name" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                  @error('title')
                ...
                <div class="col-span-6">
                    <label for="authors" class="block text-sm font-medium text-gray-700">Author(s)</label>
                    <input type="text" name="authors" id="authors" value="{{old('authors')}}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                    @error('authors')
                    <p class="text-red-500 text-xs mt-1">{{$message}}</p>
                    @enderror
                    <p class="mt-2 text-sm text-gray-500">Note: For multiple authors, indicate by adding a comma (",")</p>
                ...
                <div class="col-span-6 sm:col-span-4">
                  ...
                  <p class="text-red-500 text-xs mt-1">{{$message}}</p>
                  @enderror
                  <p class="mt-2 text-sm text-gray-500">For multiple languages, indicate by adding  comma (",") </p>
                </div>
                    ...
                    <fieldset>
                        ...
                        <div class="mt-4 space-y-4">
                          <div class="flex items-center">
                            <input id="public" name="access_right" value="public" type="radio" class="h-4 w-4 border-gray-300 text-indigo-600 focus:ring-indigo-500" checked>
                          ...
                          <div class="flex items-center">
                            <input id="private" name="access_right" value="private"  type="radio" class="h-4 w-4 border-gray-300 text-indigo-600 focus:ring-indigo-500">
                          ...
                          <div class="flex items-center">
                            <input id="group" name="access_right" value="group" type="radio" class="h-4 w-4 border-gray-300 text-indigo-600 focus:ring-indigo-500">
                          ...
                          <div id="box" style="display: none">
                            <select name="groups" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                    ...
                    <div class="col-span-6 sm:col-span-6">
                      ...
                      <div class="mt-10 col-span-6 sm:col-span-4">
                        ...
                        <input id="file_upload" name="file_upload" type="file" class="block w-full text-lg text-gray-900 bg-gray-50 rounded-lg border border-gray-300 cursor-pointer dark:text-gray-400 focus:outline-none white:bg-gray-700 white:border-gray-600 white:placeholder-gray-400" >
                        @error('file_upload')
                        <p class="text-red-500 text-xs mt-1">{{$message}}</p>
                        @enderror
                        <p class="pt-3 mb-2 text-sm text-gray-500 dark:text-gray-400">Zip is the only accepted file format</p>
                        {{-- </div> --}}
                      </div>
