...
<div class="container px-4 px-4 mb-4 mt-4 ml-14 mr-2">
  <div class="w-full bg-white rounded-lg border shadow-md white:bg-gray-800 grey:border-gray-700 pt-4 pb-4 pl-4 pr-4">
    <div class="layout">
      <div class="upload">
      <a href="{{ route('upload.create.publication') }}" id="publish">
      ...
      <div class="upload">
        <a href="{{ route('upload.create.software') }}" id="software">
      ...
      <div class="upload">
        <a href="{{ route('upload.create.dataset') }}" id="dataset">
      ...
      <div class="upload">
        <a href="{{ route('upload.create.workflow') }}" id="workflow">
