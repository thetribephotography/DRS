<x-app-layout :title="$title">
    ...
    <div class="h-[10rem] w-full bg-[#C2E7F4] pt-8 shadow">
        <div class="ml-[15rem]">
            <h2 class="mt-5 text-s3 font-bold text-cdblack">Worflow</h2>
        </div>
    </div>
    {{-- End Header --}}
                            ...
                            <div class="bg-white px-4 py-5 sm:p-6">
                                <div class="grid grid-cols-6 gap-6">
                                    ...
                                    <div class="col-span-6 sm:col-span-4">
                                        ...
                                        <input
                                            class="js-example-basic-multiple mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                                        ...
                                        <fieldset>
                                            ...
                                            <div class="mt-4 space-y-4">
                                                ...
                                                <div class="flex items-center">
                                                    <input
                                                        class="h-4 w-4 border-gray-300 text-indigo-600 focus:ring-indigo-500"
                                                        id="group" name="example" type="radio" value="2">
                                                    <label class="ml-3 block text-sm font-medium text-gray-700"
                                    ...
                                    <div class="col-span-6 mt-10 sm:col-span-4">
                                        ...
                                        <label class="mb-2 block text-sm font-medium text-gray-900 dark:text-gray-300"
                                            for="large_size">Upload Workflow File</label>
                                        <input
