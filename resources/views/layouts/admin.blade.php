...
<head>
    ...
    <!-- Scripts -->
    @vite([ 'resources/css/style.css', 'resources/js/index.js', 'resources/js/components/chart-01.js', 'resources/js/components/chart-02.js', 'resources/js/components/chart-03.js', 'resources/js/components/chart-04.js', 'resources/js/components/map-01.js' ])
...
<body class="flex h-screen overflow-hidden"
    ...
    <!-- SIDEBAR HEADER -->
    <div class=" max-w-md flex items-center justify-between gap-1 px-0 py-1.5 lg:py-1.5 flex-shrink-4 items-center font-semibold text-cdblack" style="margin-top: -60px; margin-bottom: -85px;">
        <a href="#">
    ...
    <div class="no-scrollbar flex flex-col overflow-y-auto duration-300 ease-linear">
        ...
        <!-- <div
            ...
            <h3 class="mb-1 font-semibold text-white">SoftWareRepoHub Admin</h3>
