    ...
    <div class="lg:py-12">
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg">
                <h3 class="mb-2 text-s5 font-semibold text-cdblack lg:text-s3">Welcome back
                ...
                <div
                    ...
                    <a href="">
                        <div class="">
                            <div
                                class="h-10 w-10 rounded-full bg-cmblue hover:bg-[#03739D] md:h-16 md:w-16 lg:h-24 lg:w-24">
                                <svg class="h-7 w-7 translate-x-8 translate-y-8 text-red-300" width="33"
                    ...
                    <a href="{{ route('upload.upload_list') }}">
                        <div class="">
                            <div
                                class="h-10 w-10 rounded-full bg-cmblue hover:bg-[#03739D] md:h-16 md:w-16 lg:h-24 lg:w-24">
                                <svg class="h-7 w-7 translate-x-8 translate-y-8 text-red-300" width="26"
                                    height="21" viewBox="0 0 26 21" fill="none" width="33"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
                    ...
                    <a href="{{ route('group.show_all') }}">
                        <div class="">
                            <div
                                class="h-10 w-10 rounded-full bg-cmblue hover:bg-[#03739D] md:h-16 md:w-16 lg:h-24 lg:w-24">
                                <svg class="h-7 w-7 translate-x-9 translate-y-8 text-red-300" width="26"
                                    height="19" viewBox="0 0 26 19" fill="none" width="33"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
