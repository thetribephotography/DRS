<x-guest-layout>
    <section class="bg-white py-8 lg:py-16">
        ...
        <section class="bg-white py-8 lg:py-16">
            <div class="max-w-2xl mx-auto px-4">
                <div class="flex justify-between items-center mb-6">
                  <h2 class="text-lg lg:text-2xl font-bold text-gray-900 ">Comments( {{count($upload->comments)}} )</h2>
                </div>
              <form action="/uploads/{{$upload->_id}}/comment" method="POST" class="mb-6">
                @csrf
                  ...
                  <button type="submit"
                      class=" items-center py-2.5 px-4 font-medium text-center text-white bg-blue-500 hover:bg-blue-800">
                      Post comment
                  </button>
              </form>
