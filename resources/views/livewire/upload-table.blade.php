      ...
      <tbody>
        ...
        <t  r>
          <td class="border-b border-[#eee] py-5 px-4 pl-9 dark:border-strokedark xl:pl-11">
             <img class="rounded-full w-10 h-10" src=" {{asset ('storage/' . $upload->users->profile_picture) }}" alt="Profile Picture">
          ...
          <td class="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
            <div class="flex items-center space-x-3.5">
              <button wire:click="$emit('openModal', 'upload-view', {{ json_encode(['upload' => $upload->_id]) }})" class="hover:text-primary">
              ...
              <button wire:click="$emit('openModal', 'upload-delete', {{ json_encode(['upload' => $upload->_id]) }})" class="hover:text-primary">
                <svg class="fill-current" width="18" height="18" viewBox="0 0 18 18" fill="none"
                  xmlns="http://www.w3.org/2000/svg">
                  <path
