          ...
          <div class="mx-auto max-w-242.5">
            ...
            <div class="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
              ...
              <nav>
                <ol class="flex items-center gap-2">
                  <li><a class="font-medium" href="{{route ('admin.index')}}">Dashboard /</a></li>
                  <li class="text-primary">Reported Comment</li>
                </ol>
              </nav>
            </div>
            <!-- Breadcrumb End -->
            ...
            <div
              ...
              <div class="relative z-20 h-35 md:h-65">
                <img src="{{ $show_one->user->profile_picture ? asset('storage/' . $show_one->user->profile_picture) : asset('images/user.jpeg') }}" alt="profile cover"
              ...
              <div class="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
                <div
                  ...
                  <div class="relative drop-shadow-2">
                    <img class="rounded-full w-75 h-40" src="{{ $show_one->user->profile_picture ? asset('storage/' . $show_one->user->profile_picture) : asset('images/user.jpeg') }}" alt="profile" />
                    <label for="profile"
