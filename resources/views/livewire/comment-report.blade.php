    ...
    <table class="w-full table-auto">
      ...
      <tbody>
        ...
        <tr>
          ...
          <img class="rounded-full w-12 h-12" src=" {{asset ('storage/' . $comment->user->profile_picture) }}" alt="Profile Picture">
          </td>
          <td class="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
            <p class="text-black dark:text-white"> {{$comment->user->name}} </p>
          </td>
          <td class="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
          ...
          <td class="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
            <div class="flex items-center space-x-3.5">
              <button wire:click="$emit('openModal', 'comment-show', {{ json_encode(['comment' => $comment->_id]) }})" class="hover:text-primary">
