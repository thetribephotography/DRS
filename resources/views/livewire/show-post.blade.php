<div class="mx-4 grid-rows-1 gap-4 space-y-4 md:space-y-0 lg:grid">
    @if (count($uploads) == 0)
        <p>No result found</p>
    @endif
    @foreach ($uploads as $upload)
        {{-- Main --}}
        <div class="mb-8 mt-6 w-full font-inter md:w-[24rem] lg:w-[60rem]">
                ...
                <div class="my-2 flex flex-col md:mt-0 lg:ml-4">
                    ...
                    <div class="flex justify-between lg:justify-start">
                        @if ($upload->access_id == 1)
                            ...
                            <div class="mr-4 flex text-s8 text-[#6F737A]">
                                <svg class="h-3 w-3 translate-y-1" xmlns="http://www.w3.org/2000/svg" fill="none"
                        ...
                        @elseif ($upload->topic_id == 4)
                            {{-- Type --}}
                            <div class="mr-4 flex text-s8 text-[#6F737A]">
                                <svg class="h-3 w-3 translate-y-1" viewBox="0 0 55 50" fill="none"
                        ...
                        {{-- Size --}}
                        <div class="mr-4 flex text-s8 text-[#6F737A]">
                            <svg class="translate-y-1" width="13" height="13" viewBox="0 0 13 13"
                    ...
                    <div class="mt-1">
                        <a class="text-decoration-none hover:underline" href="/upload/public/{{ $upload->slug }}">
                            <h3 class="text-s6 font-semibold text-cdblack md:font-regular">
                                {{ $upload->title }}
                            </h3>
                        </a>
