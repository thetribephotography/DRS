<div class="flex h-screen w-full flex-col items-center justify-center">
    <svg class="w-1/2 text-blue-600 md:w-1/3 lg:w-1/4" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg"
    ...
    <div class="flex flex-col items-center justify-center">
        <p class="mt-8 text-5xl font-bold tracking-wider text-gray-600 md:text-6xl lg:text-7xl">500</p>
        <p class="mt-2 text-2xl font-bold text-gray-600 md:text-3xl lg:text-4xl">Server Error</p>
        <p class="mt-4 text-gray-500 md:text-lg xl:text-xl">Whoops, something went wrong on our servers.</p>
    </div>
</div>
