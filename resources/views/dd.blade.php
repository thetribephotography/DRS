...
<body class="font-inter antialiased">
    ...
    <div class="flex">
        ...
        <div class="relative h-screen bg-blue-500" x-data="{ open: false }">
            {{-- Side Bar --}}
            <div x-bind:class="!open ? 'relative left-0 flex h-screen w-20 flex-col bg-white p-4' :
                'relative left-0 flex h-screen w-60 flex-col bg-white p-4'"
                x-show="!open">
                {{-- Logo action --}}
                <div class="mt-2 flex h-10 w-full flex-row items-center">
                    ...
                    {{-- Logo text --}}
                    <span class="pl-4 text-lg font-semibold text-cmblue" x-show="open">SoftwareRepoHub</span>
                ...
                <div class="mt-10">
                    <ul>
                        <li
                            class="my-2 flex h-10 w-full cursor-pointer items-center rounded-md bg-cmblue text-s7 text-white">
                        ...
                        <li
                            class="hover:bg-cm-blue delay-50 my-2 flex h-10 w-full cursor-pointer items-center rounded-md text-s7 text-cmblue transition duration-200 ease-in-out hover:bg-cmblue hover:text-white">
                            <a class="text-md ml-3 flex flex-row" href="#">
                                <svg class="mr-4 h-5 w-5" xmlns="http://www.w3.org/2000/svg" fill="none"
                                    viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round"
                        ...
                        <li
                            class="my-2 flex h-10 w-full cursor-pointer items-center rounded-md text-s7 text-cmblue transition duration-200 ease-in-out hover:bg-cmblue hover:text-white">
                            <a class="text-md ml-3 flex flex-row" href="#">
                                <svg class="mr-4 h-5 w-5" xmlns="http://www.w3.org/2000/svg" fill="none"
                                    viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round"
                        ...
                        <li
                            class="mt-10 flex h-10 w-full cursor-pointer items-center rounded-md text-s7 text-cmblue transition duration-200 ease-in-out hover:bg-cmblue hover:text-white">
                            <a class="text-md ml-3 flex flex-row" href="#">
                                <svg class="mr-4 h-5 w-5" xmlns="http://www.w3.org/2000/svg" fill="none"
                                    viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round"
        ...
        {{-- Main content --}}
        <div class="h-screen w-screen bg-yellow-300 p-6">
            <div class="h-screen w-full bg-green-500" x-data="{ open: false }">
                <button class="rounded bg-red-500 p-2" @click="open = !open">
                    Click me
                </button>
                <div class="bg-gray-700" x-show="open">
                    Welcome Aboard
                </div>
            </div>
        </div>
