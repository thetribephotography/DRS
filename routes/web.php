...
Route::prefix('')->middleware(['auth', 'role:registered', 'verified'])->group(function () {
    ...
    Route::put('upload/update/article/{id}', [UploadController::class, 'article_update'])->name('upload.update.article');
    ...
    Route::put('upload/update/software/{id}', [UploadController::class, 'software_update'])->name('upload.update.software');
    ...
    Route::put('upload/update/dataset/{id}', [UploadController::class, 'dataset_update'])->name('upload.update.dataset');
    ...
    Route::put('upload/update/workflow/{id}', [UploadController::class, 'workflow_update'])->name('upload.update.workflow');
